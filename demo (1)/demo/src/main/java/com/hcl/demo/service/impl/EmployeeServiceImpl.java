...
public class EmployeeServiceImpl implements EmployeeService{
	...
	public List<EmployeeRequestDto> getEmployeesBySorting(int pageNumber, int pageSize) {
		...
		List<EmployeeRequestDto> employeeRequestDtos=new ArrayList<EmployeeRequestDto>();
		EmployeeRequestDto employeeRequestDto=new EmployeeRequestDto();
		for(Employee employee:employees) {
			BeanUtils.copyProperties(employee,employeeRequestDto);
